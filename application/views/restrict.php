	...
	<div class="container">
		...
		<div class="container">
			...
			<ul class="nav nav-tabs">
				...
				<li><a href="#tab_service" role="tab" data-toggle="tab">Serviços</a></li>
			...
			<div class="tab-content">
				...
				<div id="tab_service" class="tab-pane">
					<div class="container-fluid">
						...
						<a id="btn_add_service" class="btn btn-primary"><i class="fa fa-plus">&nbsp;&nbsp;Adicionar Serviço</i></a>
			...
			<div class="modal-body">
				<form id="form_service">
					...
					<div class="form-group">
						<label class="col-lg-2 control-label">Imagem</label>
						<div class="col-lg-10">
							<img id="service_img_path" src="" style="max-height: 400px; max-height: 400px">
							<label class="btn btn-block btn-info">
								<i class="fa fa-upload"></i>&nbsp;&nbsp;Importar Imagem
								<input type="file" id="btn_upload_service_img" accept="image/*" style="display:none;">
							</label>
							<input id="service_img" name="service_img">
							<span class="help-block"></span>
					...
					<div class="form-group text-center">
						<button type="submit" id="btn_save_service" class="btn btn-primary">
							<i class="fa fa-save"></i>&nbsp;&nbsp;Salvar
						</button>
						<span class="help-block"></span>
					</div>
