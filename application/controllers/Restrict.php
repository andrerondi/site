...
{	
	...
	public function index()
	{
		...
		else
		{
			...
			//echo password_hash("Slippb174", PASSWORD_DEFAULT);
	...
	public function ajax_save_course()
	{
		...
		{
			if ($this->courses_model->is_duplicated("couse_name", $data["course_name"], $data["course_id"]))
			{
	...
	public function ajax_save_user()
	{
		...
		{
			$json["error_list"]["#user_login"] = "E-mail é obrigatório!";
		}
		else
		{
